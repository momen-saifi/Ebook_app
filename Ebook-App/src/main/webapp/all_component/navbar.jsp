...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<div class="col-md-3">
			<a href="login.jsp" class="btn btn-success"><i class="fas fa-user-plus" aria-hidden="true"></i>${userobj.name  }</a> 
			<a href=""
...
<div class="col-md-3">
<i class="fa fas-cart-plus"></i>
			<a href="login.jsp" class="btn btn-success"><i class="fas fa-sign-in-alt"></i>Login</a> <a href="register.jsp"
				class="btn btn-primary text-white"><i class="fas fa-user-plus" aria-hidden="true"></i>Register</a>
		</div>
</c:if>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link" href="all_recent_book.jsp"><i
					class="fa fa-book-open"></i>Recent Book</a></li>
		...
		<form class="form-inline my-2 my-lg-0">
			<button class="btn btn-light-success my-2 my-sm-0" type="submit">
